...
import dao.RewardDAOImplementation; // Use implementation for now, or inject interface
import model.Reward;
import util.InputHelper; // Assuming this is your utility for user input
...
public class RewardManager {
    ...
    public RewardManager(InputHelper inputHelper) {
        ...
        this.rewardDao = new RewardDAOImplementation(); // Instantiate the DAO
    }
    ...
    public void updateReward() { // Changed to public as per interface (if applicable)
        ...
        try {
            ...
            if (existingRewardOptional.isPresent()) {
                ...
                // IssueDate is typically not updated manually
