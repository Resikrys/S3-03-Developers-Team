...
public class RoomMenu {
    ...
    // Constructor actualizado para incluir NotificationManager
    public RoomMenu(InputHelper inputHelper, PlayerDao playerDao, NotificationManager notificationManager) {
        this.inputHelper = inputHelper;
        this.roomManager = new RoomManager(inputHelper, playerDao, notificationManager);
    }
